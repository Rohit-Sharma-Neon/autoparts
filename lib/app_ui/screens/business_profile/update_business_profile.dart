...
class UpdateBusinessProfile extends StatefulWidget {
  static const routeName = "/update-business-profile";
  final bool isNewUser;
  const UpdateBusinessProfile({Key? key,this.isNewUser = false}) : super(key: key);
...
class _UpdateBusinessProfileState extends State<UpdateBusinessProfile> {
  ...
  setData() {
    ...
    whatsAppCountryCode = userProfileData?.whatsappCountryCode??userProfileData!.countryCode;
    mobileController.text = userProfileData!.mobile!;
    whatsAppNumberController.text = userProfileData!.whatsappMobile ?? "";
